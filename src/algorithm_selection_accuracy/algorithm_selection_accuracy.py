...
from train_as_accuracy_knn import train_and_test_knn
from train_as_accuracy_forward_knn import train_and_test_forward_knn
...
def get_features(
    ...
    if features_type == 'wl-1':
        ...
        return compute_wl_features(train_data, test_data, 'node_features', 1, False, True)
    elif features_type == 'wlun-2':
        return compute_wl_features(train_data, test_data, 'node_features', 2, False, True)
