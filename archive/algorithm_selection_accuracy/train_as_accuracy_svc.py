...
def cross_val_score(clf:SVC, X:np.ndarray, y:np.ndarray, cv:int=5) -> float:
...
def train_and_test_svc(train_data:list[dict], test_data:list[dict], hyperparams:None|dict=None) -> dict:
